...
const ClubRatings = () => {
  ...
  const handleSave = () => {
    // In future this would persist to DB
  ...
  return (
    <div className="container mx-auto pt-8 pb-16 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Club Ratings</h1>
        <p className="text-muted-foreground">
          Customize how player ratings are calculated for each position by adjusting attribute weights.
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center gap-2">
            <Checkbox
              id="league-adj"
              checked={leagueAdjustments}
              onCheckedChange={(v) => setLeagueAdjustments(!!v)}
            />
